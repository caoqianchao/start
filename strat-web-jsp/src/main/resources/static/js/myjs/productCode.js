 ...
 */
	...
	function saveD(){
		...
		var fields = dname + ',ecpss,' + dtype + ',ecpss,' + dbz + ',ecpss,' + isQian + ',ecpss,' + ddefault;
	...
	function editField(value,msgIndex){
		var efieldarray = value.split(',ecpss,');
	...
	function appendC(value){
		...
		var fieldarray = value.split(',ecpss,');
	...
	function isSame(value){
		for(var i=0;i<arField.length;i++){
			var array0 = arField[i].split(',ecpss,')[0];
			if(array0 == value){
				return false;
			}
		}
