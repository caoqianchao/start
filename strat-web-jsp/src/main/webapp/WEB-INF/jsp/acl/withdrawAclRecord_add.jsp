...
<div class="container-fluid" id="main-container">
    <div id="page-content" class="clearfix">
        <div class="row-fluid">
            <div class="row-fluid">
                <!-- 检索  -->
                <form method="post" id="form1" action="/finance/acl/addWithdrawAcl" onsubmit="return checkSubmit();">
                    <div id="zhongxin">
                        <table class="table table-striped table-bordered table-hover" id="table_report">
                            ...
                            <td>
                                <input id="merNo" type="text" name="merNo" value="">
                            </td>
                            <tr>
                                <td style="width:70px;text-align: right;padding-top: 13px;">结算至提现账户比例:</td>
                                <td>
                                    <input id="rate" type="text" name="rate" value="0.1"/>
                                </td>
                            </tr>
                            <tr>
