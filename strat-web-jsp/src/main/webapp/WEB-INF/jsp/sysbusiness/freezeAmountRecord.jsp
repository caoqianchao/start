...
<div class="container-fluid" id="main-container">
    <div id="page-content" class="clearfix">
        <div class="row-fluid">
            <div class="row-fluid">
                <!-- 检索  -->
                <form action="freezeAmountBusiness" method="post" name="Form" id="Form">
                    <table>
                        <tr>
                            <td>
                                <span class="input-icon">
                                    <input id="requestNo" name="requestNo" type="text" value="${requestNo}"
                                ...
                                <c:forEach items="${page.list}" var="record" varStatus="vs">
                                    <tr>
                                        ...
                                        <td style="width: 60px;" class="center">
                                            <c:if test="${record.canUnFreeze}">
                                                <div class='hidden-phone visible-desktop btn-group'>
                                                    <a class='btn btn-mini btn-primary' title="解冻"
                                                       href="javascript:void(0);"
                                                       onclick="unFreezeAmount(${record.id})">
                                                        解冻金额
                                                    </a>
                                                </div>
                                            </c:if>
...
<script type="text/javascript">
    ...
    function unFreezeAmount(id) {
        ...
        $.post("./unFreezeAmount",{recordID:id},function(res){
            if(res == "ok"){
                alert("操作成功");
                window.location.href='freezeAmountBusiness';
            } else {
                alert(decodeURI(res));
                window.location.href='freezeAmountBusiness';
            }
    ...
    function xlsxImportTask() {
        ...
        diag.Drag = true;
        diag.Title = "批量解冻导入";
        diag.URL = '/finance/toExcelImportUnfreeze';
        diag.Width = 650;
        diag.Height = 600;
        diag.CancelEvent = function () {
            $("#Form").submit();
