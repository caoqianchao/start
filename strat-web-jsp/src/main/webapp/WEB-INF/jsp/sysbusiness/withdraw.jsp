...
<div class="container-fluid" id="main-container">
    <div id="page-content" class="clearfix">
        <div class="row-fluid">
            <div class="row-fluid">
                <!-- 检索  -->
                <form action="withdrawBusiness" method="post" name="Form" id="Form">
                    <table>
                        <tr>
                            <td>
                                <span class="input-icon">
                                    <input id="requestNo" name="requestNo" type="text" value="${requestNo}"
                                           placeholder="请输入查询请求流水号"/>
                                </span>
                            </td>
                            <td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 60px;" class="center">
                                            <div class='hidden-phone visible-desktop btn-group'>
                                                <a class='btn btn-mini btn-primary' title="重新通知"
                                                   href="javascript:void(0);"
                                                   onclick="notifySuccess('${record.merNo}','${record.systemNo}')">
                                                    重新通知
                                                </a>
                                            </div>
                                        </td>
...
<script type="text/javascript">
    ...
    function notifySuccess(merNo, systemNo) {
        if (merNo == null | merNo == "") {
            alert("商户号不能为空");
            return;
        }
        ...
        $.post("./notifyWithdrawResult",{merNo:merNo,systemNo:systemNo},function(res){
            if(res == "ok"){
                alert("操作成功");
            } else {
                alert(res);
